...
from define_planta import define_parameters, calculate_plant_parameters, define_plant, design_pid_controller, define_open_loop_system, define_closed_loop_system
...
def Respuesta_frecuencia_abierto(type):
